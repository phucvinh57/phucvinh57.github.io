...
public class MyItem extends BaseAdapter {
        ...
        rmvBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    for(int i=0;i<addMenu.size();i++){
                        removeDataInFile(menuTitles.get(i+6)+".txt", context, rmv);
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
        ...
        cmp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    for(int i=0;i<addMenu.size();i++){
                        removeDataInFile(menuTitles.get(i+6) +".txt", context, cl);
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
    ...
    public MyItem(Activity activity, Context context, ArrayList<String> arrayList, ArrayList<String> a1, ArrayList<String> a2, ArrayList<String> a3,  ArrayList<String> a4,  ArrayList<String> a5, ArrayList<String> completed, ArrayList<ArrayList<String>> addMenu){
    ...
    public void setFilename(String f1, String f2, String f3, String f4, String f5, String f6, String f7, ArrayList<String> menuTitles){
